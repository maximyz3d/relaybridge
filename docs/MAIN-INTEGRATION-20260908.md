...
The corrected source `45798e8b70ebd7a1271b85c1dfbd542ae1590b30` now passes [Linux and Windows CI](https://github.com/maximyz3d/relaybridge/actions/runs/34184613952), including Windows MCP/installer lifecycle, and [CodeQL](https://github.com/maximyz3d/relaybridge/runs/101930507826) after individually justified dispositions. Fresh closing Sonnet/high approvals are `rcpt_mts4qnpm_e2648545` and the six-location corrective review `rcpt_mts4v4tl_a5d8c15e`; complete task/invocation identities and limitations are committed in the CodeQL review. The subsequent commit changes these two evidence documents only. Shared runtime remains NOT DEPLOYED/NOT RESTARTED; issue122 recovery and controller/goal acceptance gaps remain unchanged.
