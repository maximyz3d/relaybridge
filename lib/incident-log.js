...
const CLASSIFICATIONS = Object.freeze([
  ...
  'bridge_interrupted',
  'supervision_stall',     // supervisor stall evidence (notify / unsampled CPU); never a kill
]);
...
function taskFailureDetails(task = {}) {
  ...
  const actions = {
    ...
    supervision_stall: "Inspect the run's check-in evidence in list_active_runs; the supervisor did not stop it. Cancel explicitly only if the evidence shows no progress.",
  };
